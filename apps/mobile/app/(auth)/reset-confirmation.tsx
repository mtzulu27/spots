...
import { PrimaryAction } from '@/components/auth-wireframe';
      ...
      <View style={styles.content}>
        ...
        >
          <View style={styles.hero}>
            <Text style={styles.quote}>Revisa tu correo</Text>
            <Text style={styles.description}>
              Si la cuenta existe, te enviamos un enlace para recuperar tu acceso
            </Text>
          </View>
          ...
          <View style={styles.formWrap}>
            <View style={styles.form}>
              ...
              <View style={styles.actionRow}>
                ...
                >
                  <Text style={styles.actionLink}>Probar otro correo</Text>
                </Pressable>
              </View>
            </View>
          </View>
          ...
          <Text style={styles.legalText}>
            Revisa también la carpeta de spam o promociones si no lo ves enseguida
          </Text>
        </Animated.View>
      </View>
    </View>
